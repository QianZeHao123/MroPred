...
def preprocess_data_nomil(
    ...
    data["hard_braking_per_mile"] = data["hard_braking"] / data["day_mileage"]
    data["hard_acceleration_per_mile"] = data["hard_acceleration"] / data["day_mileage"]
    data["speeding_sum_per_mile"] = data["speeding_sum"] / data["day_mileage"]
    ...
    continuous_variable = [
        ...
        # "speeding_sum",
        # "day_mileage",
        "hard_braking_per_mile",
        "hard_acceleration_per_mile",
        "speeding_sum_per_mile",
        "engn_size",
        "est_hh_incm_prmr_cd",
    ...
    if add_driver_behavior:
        agg_rules["hard_braking_per_mile"] = agg_fun
        agg_rules["hard_acceleration_per_mile"] = agg_fun
        agg_rules["speeding_sum_per_mile"] = agg_fun
