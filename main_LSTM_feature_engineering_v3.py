...
log_file_path = os.path.join(log_dir, f"training_log_{timestamp}_LSTM_super.csv")

pt_model_dir = os.path.join(log_dir, "models")
os.makedirs(pt_model_dir, exist_ok=True)


model_save_path = os.path.join(pt_model_dir, f"best_model_{timestamp}_LSTM_super.pth")
pt_model_save_path = os.path.join(pt_model_dir, f"best_model_{timestamp}_LSTM_super.pt")
